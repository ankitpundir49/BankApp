...
class DataNet extends Component
{   state={ data:[],
        };
async fetchData()
        ...
        <div className="row">
            ...
            <div className="col-9">
                ...
                <div className="row">
                    ...
                    <div className="col-2 border">Payee Name</div>
                ...
                {data.map((st,index)=>(
                    <div className={index%2?"row":"row bg-light"} key={st.name}>
                            ...
                            <div className="col-2 border">{st.payeeName}</div>
                            <div className="col-2 border">{st.amount}</div>
